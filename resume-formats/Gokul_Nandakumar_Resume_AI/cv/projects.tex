...
\cventry
    ...
    \href{https://ieeexplore.ieee.org/document/10094490}
       {\textcolor{blue}{\faLink\ IEEE Xplore}}}
    {}
    {
      \begin{cvitems}
        \item {Built a {\bf CNN-based deep learning model} to classify five yoga postures using a curated image dataset; achieved {\bf 99.49\% accuracy} with VGG19.}
        \item {Performed data labeling, augmentation, and validation to ensure high-quality model training input across {\bf CNN, VGG16, VGG19, and MobileNet}.}
        \item {Published in {\bf IEEE Xplore}, demonstrating expertise in multimodal content generation and AI dataset curation for model training tasks.}
      \end{cvitems}
    }

%---------------------------------------------------------
\cventry
    {Analysis of Pre and Post Covid-19 Pandemic Layoffs 
    \href{https://github.com/Goku007007/Analysis-of-Pre-and-Post-Covid-19-Pandemic-Layoffs}
       {\textcolor{blue}{\faGithub\ GitHub}}}
    {}
    {
      \begin{cvitems}
        \item {Led data collection and annotation of global layoff datasets (2019–2023) from {\bf Layoffs.fyi}, enabling workforce trend prediction and bias detection.}
        \item {Applied {\bf XGBoost, Random Forest, and Logistic Regression} for anomaly classification and feature importance analysis, identifying high-risk industries.}
        \item {Documented results in IEEE-style paper demonstrating AI-driven workforce analytics using structured text data and model interpretability.}
        \item {Stack: {\bf Python (Pandas, Seaborn, Scikit-learn), Data Annotation, Visualization}. Showcases analytical judgment and data audit capabilities.}
      \end{cvitems}
    }

%---------------------------------------------------------
\cventry
    {EV Charger Uptime \& Coverage Pulse (U.S.) 
    \href{https://github.com/Goku007007/ev-charger-uptime-snapshot}
       {\textcolor{blue}{\faGithub\ GitHub}}}
    {}
    {
      \begin{cvitems}
        \item {Engineered reproducible data pipelines in {\bf BigQuery + GCS}, ingesting $\sim$83k station records and transforming into star-schema marts.}
        \item {Built {\bf Tableau dashboards} with interactive KPIs and geospatial analytics; reduced manual QA checks by 70\%.}
        \item {Stack: {\bf Python, SQL, BigQuery, Tableau}. Demonstrates strong data preparation and analytical accuracy — key for annotation QA.}
      \end{cvitems}
    }
