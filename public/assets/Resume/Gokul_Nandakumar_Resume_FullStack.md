Gokul Nandakumar  
[goku.careers@gmail.com](mailto:goku.careers@gmail.com) | [Portfolio](https://gokuldata.vercel.app/) | g[ithub](https://github.com/Goku007007).com/Goku007007 | L[inkedi](https://www.linkedin.com/in/gokul-nandakumar/)n | \+1 (773) 930 2964 

Skills  
**Languages:** Python, JavaScript, TypeScript, SQL, HTML5, CSS3 **Frontend:** React, Next.js, Angular, Recharts, Chart.js, Tailwind CSS **Backend:** Python (Django, FastAPI, Flask), Node.js (Express), RESTful APIs, Microservices **Db:** PostgreSQL, Redis, MySQL, MongoDB, Query Optimization, Schema Design **Cloud & DevOps:** Azure, AWS, Docker, CI/CD, GitHub Actions **Tools:** Git, pytest, Jest, Selenium, Webhooks, OAuth **Cert:**  AWS Certified Solutions Architect \- Associate   
**AI \- Assisted Dev & API**: Cursor, Claude Code, ChatGPT-Cli-or-Codex, Cursor, Antigravity, LLM and Vid Gen APIs  
Experience  
**Software Engineer**, ChiEAC \- Chicago, IL (Remote)	Jun 2025 \- Present
...
**Software Engineer**, ISQL Global \- Remote	Oct 2022 \- Jul 2023
...
**Software Engineer**, Out In Dreams \- Remote	Sep 2021 \- Oct 2022
...
Projects  
**National EV Charging Infrastructure Analytics**	[Github](https://github.com/Goku007007/ev-charger-uptime-snapshot)
...
**GPU Cluster Telemetry & Observability System**	[Github](https://github.com/Goku007007/gpu-telemetry-lakehouse)

* BuiltBuilt a scalable observability platform using Python and DuckDB to monitor GPU cluster performance, ingesting 10M+ trace rows for granular utilization tracking.  
* Implemented an IsolationForest machine learning model to detect abnormal cluster behavior, reducing false alerts

Education  
**Illinois Institute of Technology** \- Master of Information Technology  
**SREC** \- Bachelor of Computer Science and Engineering